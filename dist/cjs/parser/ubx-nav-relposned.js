...
var UBX_NAV_RELPOSNED_Parser = /** @class */ (function (_super) {
    ...
    UBX_NAV_RELPOSNED_Parser.prototype.parse = function (payload) {
        return {
            ...
            relPosHeading: payload.readInt32LE(24) * 1e-5,
            relPosHPN: payload.readInt8LE(32) * 0.1,
            relPosHPE: payload.readInt8LE(33) * 0.1,
            relPosHPD: payload.readInt8LE(34) * 0.1,
            relPosHPLen: payload.readInt8LE(35) * 0.1,
            accN: payload.readUInt32LE(36) * 0.1,
            accE: payload.readUInt32LE(40) * 0.1,
            accD: payload.readUInt32LE(44) * 0.1,
            accLength: payload.readUInt32LE(48) * 0.1,
            accHeading: payload.readUInt32LE(52) * 1e-5,
            ...
            relPosHeadingValid: (0, Utils_1.readBitFromUInt16)(payload.readUInt8(60), 8) == 1,
