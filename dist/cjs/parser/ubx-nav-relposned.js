...
var UBX_NAV_RELPOSNED_Parser = /** @class */ (function (_super) {
    ...
    UBX_NAV_RELPOSNED_Parser.prototype.parse = function (payload) {
        return {
            ...
            relPosHeading: payload.readInt32LE(24),
            relPosHPN: payload.readInt8LE(32),
            relPosHPE: payload.readInt8LE(33),
            relPosHPD: payload.readInt8LE(34),
            relPosHPLen: payload.readInt8LE(35),
